...
*/
__global__ void turboquant_full_4bit_lane_word_lane_nibble_qjl512_combined_reduction_logits_b1q1_d128_kernel(
...
void validate_lane_nibble_signs(torch::Tensor signs) {
    ...
    TORCH_CHECK(
        ...
        "lane_nibble_qjl_signs must be [1,H,T,64]"
    );
}
...
torch::Tensor turboquant_full_4bit_lane_word_lane_nibble_qjl512_combined_reduction_logits_b1q1_d128_cuda(
    ...
    turboquant_full_4bit_lane_word_lane_nibble_qjl512_combined_reduction_logits_b1q1_d128_kernel<<<grid, block>>>(
