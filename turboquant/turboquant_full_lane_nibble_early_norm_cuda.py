...
def _load_ext():
    ...
    if _EXT is None:
        src = (
            ...
            / "csrc"
            / "turboquant_full_lane_nibble_early_norm_cuda.cu"
        )
        _EXT = load(
            name="true_turboquant_full_lane_nibble_early_norm_cuda_ext",
            sources=[str(src)],
...
@torch.no_grad()
def turboquant_full_4bit_lane_nibble_qjl128_early_norm_logits_b1q1_d128_cuda(
    *,
    ...
    return _load_ext().turboquant_full_4bit_lane_nibble_qjl128_early_norm_logits_b1q1_d128_cuda(
