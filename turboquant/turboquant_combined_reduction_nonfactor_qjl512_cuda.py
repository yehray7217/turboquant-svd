...
def _load_ext():
    ...
    if _EXT is None:
        src = (
            ...
            / "csrc"
            / "turboquant_combined_reduction_nonfactor_qjl512_cuda.cu"
        )
        _EXT = load(
...
@torch.no_grad()
def turboquant_full_4bit_lane_word_lane_nibble_qjl512_combined_reduction_logits_b1q1_d128_cuda(
    *,
    ...
    return _load_ext().turboquant_full_4bit_lane_word_lane_nibble_qjl512_combined_reduction_logits_b1q1_d128_cuda(
